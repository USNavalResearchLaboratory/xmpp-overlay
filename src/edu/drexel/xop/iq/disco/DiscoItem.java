 ...
 * NOTE: This code was taken from Jive Software and used in XOP
 *
...
public class DiscoItem {
     ...
     *               (required).
     * @param name   specifies a natural-language name for the item (can be null).
     * @param node   specifies the particular node associated with the JID of the
     *               item "owner" or location (can be null).
     * @param action specifies the action to be taken for the item.
     * @throws IllegalArgumentException If a required parameter was null, or if the supplied 'action'
